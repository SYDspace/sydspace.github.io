...
* Version 1.0
    - [kapsule-core]({{ site.rooturl }}/kapsule/docs/1.0/kapsule-core/index.html)
* Version 0.3
    - [kapsule-core]({{ site.rooturl }}/kapsule/docs/0.3/kapsule-core/index.html)
* Version 0.2
    - [kapsule-core]({{ site.rooturl }}/kapsule/docs/0.2/kapsule-core/index.html)
* Version 0.1
    - [kapsule-core]({{ site.rooturl }}/kapsule/docs/0.1/kapsule-core/index.html)

<a name="links"/>
## Links 

* [GitHub](https://github.com/sydspace/kapsule)
